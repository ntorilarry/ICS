        ...
        <div className="max-w-7xl container px-6 py-10 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            ...
            >
              <div className="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100">
                <h2 className="mt-4 text-xl font-semibold text-white capitalize">
                  Melachconuts Website
                </h2>
                <a
                  href="http://www.melachcoconuts.com/"
                  className="mt-2 text-lg tracking-wider text-blue-400 uppercase "
                >
                  Website
                </a>
            ...
            >
              <div className="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100">
                ...
                <a
                  href="http://www.goldmaxprojects.com/"
                  className="mt-2 text-lg tracking-wider text-blue-400 uppercase "
                >
                  Website
                </a>
            ...
            >
              <div className="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100">
                <h2 className="mt-4 text-xl font-semibold text-white capitalize">
                Houseofabnaagh Website
                </h2>
                <a
                  href="http://www.houseofabnaagh.com/"
                  className="mt-2 text-lg tracking-wider text-blue-400 uppercase "
                >
                  Website
                </a>
            ...
            >
              <div className="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100">
                <h2 className="mt-4 text-xl font-semibold text-white capitalize">
                Opkcompanyltd Website
                </h2>
                <a
                  href="http://www.opkcompanyltd.com/"
                  className="mt-2 text-lg tracking-wider text-blue-400 uppercase "
                >
                  Website
                </a>
