          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
            ...
            <div className="max-w-5xl text-center mx-auto">
              <h1 className="block font-medium text-gray-200 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
                We are transforming an Industry through Technological and
                Digital Solutions. Let’s talk! Grow your business with Us
              </h1>
            </div>

            <div className="max-w-3xl text-center mx-auto">
              <p className="text-lg text-gray-400">
                ICS is here to Provide adequate and speed proficiency skills to
                elevate the image of our clients.
              </p>
            </div>
          </div>
        </div>
